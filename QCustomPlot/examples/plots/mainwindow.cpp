...
void MainWindow::realtimeDataSlot()
{
  ...
  if (ui->customPlot->graph(0)->data()->size()>1000)
  {
    ui->customPlot->graph(0)->data()->removeBefore(lastPointKey - 9);
  }
  if (ui->customPlot->graph(1)->data()->size()>1000)
  {
    ui->customPlot->graph(1)->data()->removeBefore(lastPointKey - 9);
  }
